...
class StandardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create standard" do
    assert_difference("Standard.count") do
      post standards_url, params: { standard: { qty: @standard.qty, title: @standard.title } }
    end
  ...
  test "should update standard" do
    patch standard_url(@standard), params: { standard: { qty: @standard.qty, title: @standard.title } }
